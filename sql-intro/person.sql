...
Height int,
City varchar (300),
FavoriteColor varchar(300),
);

-- Add 5 different people into the person database. Remember to not include the person_id because it should auto-increment.
INSERT INTO Persons( Name, Age, Height, City, FavoriteColor) VALUES 
(‘Bob’, ‘21’, 180, 'Antioch' , 'red'),
(‘Jason’, ‘31’, 180, 'Antioch' , 'purple'),
(‘Robbin’, ‘41’, 180, 'Antioch' , 'red'),
(‘Brad’, ‘51’, 180, 'Fremont' , 'blue'),
(‘Johny’, ‘61’, 180, 'Antioch' , 'red');
...
SELECT * FROM person WHERE favorite_color IN ( 'green', 'blue', 'orange' );
